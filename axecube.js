...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .blocBadge.trouve .n{animation:blocPulse 1.1s ease-in-out infinite}
...
async function chargerWorkers(d){
  ...
  document.getElementById('w_via').textContent=estPublicPool?'(via public-pool.io)':estMineshop?'(via mineshop.eu)':estNmminer?'(via nmminer.com)':estSolopool?'(via solopool.com)':estNerdminer?'(via nerdminer.io)':'';
  ...
  if(!estPublicPool && !estMineshop && !estNmminer && !estSolopool && !estNerdminer){box.innerHTML='<span style="color:var(--mut)">Disponible uniquement sur public-pool.io, Mineshop.eu, NMMiner Solo, SoloPool.com ou NerdMiner Pool.</span>';return;}
  try{
